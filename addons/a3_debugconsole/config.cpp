...
{
	uo_debugconsole_preInit = "call compile preprocessFileLineNumbers '\x\uo\addons\a3_debugconsole\XEH_preInit.sqf'";
};
class Extended_PostInit_EventHandlers
{
	uo_debugconsole_postInit = "call compile preprocessFileLineNumbers '\x\uo\addons\a3_debugconsole\xeh_postInit.sqf'";
};
