...
Syntax:
        [(detailInt, intervalInt)] call UO_fnc_mapMonitor;

Example(s):
        [] call UO_fnc_mapMonitor; // Default configuration
        [0] call UO_fnc_mapMonitor; // Low detail and normal updates
        [3, 1] call UO_fnc_mapMonitor; // Very high detail and updates of 1 second

Editable Variable(s): (You may change these variables in-game if needed)
        uo_mapMonitor_constantUpdate = false; // Whether markers should update while the map isn't open.
        ...
        uo_mapMonitor_bulletMarkerRefreshRate = 10; // Hertz of bullet tracking refresh rate, same as FPS.
*/
