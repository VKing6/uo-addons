//TODO: 
//launcher animate ["Loaded",1] state by default on used AT4 in cfgVehicles
//launcher animate ["cover_rearSight",1]; state by default on used AT4 in cfgVehicles
//What I have there now clearly does not work for either. :c

class CfgPatches
{
	class inko_disposable_a3
	{
		units[] = {"INKO_NLAW_USED_TUBE"};
		weapons[] = {"INKO_NLAW_USED"};
		requiredVersion = 0.1;
...
class CfgCloudlets
{
	...
	{
		beforeDestroyScript = "\x\uo\addons\a3_nametags\empty.sqf"; //This entire beforeDestroyScript should be removed, but alas
	};
	class RHS_Fired_RPG18 : RHS_Fired_RPG26
	{
		beforeDestroyScript = "\x\uo\addons\a3_nametags\empty.sqf";
	};
